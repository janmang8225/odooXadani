...
export async function assignRequest(req: Request, res: Response) {
  const auth = (req as any).auth;
...
export async function repairRequest(req: Request, res: Response) {
  const auth = (req as any).auth;
  const id = req.params.id;
...
export async function scrapRequest(req: Request, res: Response) {
  const auth = (req as any).auth;
  const id = req.params.id;
